...
export default function PortalFinanceiroPage() {
  ...
  const fetchInvoices = async () => {
    try {
      setLoading(true);
      // Buscar TODAS as faturas (o backend deve filtrar por cliente quando tivermos auth)
              ...
              <div key={invoice.id} className="p-6 hover:bg-gray-50">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mb-1">{invoice.descricao}</p>
                    <p className="text-xs text-gray-500 mb-3">{invoice.project_nome}</p>
                  ...
                  <div className="flex flex-col gap-2 ml-4">
                    ...
                    {(invoice.status === InvoiceStatus.PENDENTE || invoice.status === InvoiceStatus.ATRASADO) && (
                      <label className="cursor-pointer bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center gap-2 text-sm whitespace-nowrap">
                    ...
                    {invoice.status === InvoiceStatus.AGUARDANDO_CONF && (
                      <div className="bg-blue-100 text-blue-700 px-4 py-2 rounded-lg text-sm flex items-center gap-2 whitespace-nowrap">
                    ...
                    {invoice.nota_fiscal_url && (
                      <a
                        ...
                        className="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 flex items-center gap-2 text-sm whitespace-nowrap"
                      >
